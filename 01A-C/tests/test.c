...
START_TEST (test_main_loop)
{
	...
	// which should result in sum(2,2,654,33583) = 34241
	
	ck_assert_int_eq(read_evaluate_all_modules(file), 34241);
}
END_TEST
...
START_TEST (test_mass_to_fuel_req)
{
	...
	ck_assert_int_eq(get_module_fuel_req(1969), 654);
	ck_assert_int_eq(get_module_fuel_req(100756), 33583);
